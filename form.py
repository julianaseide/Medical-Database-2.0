...
c1.grid(row = 2, column = 0, sticky = "e")
...
q1.grid(row = 4, column = 0, sticky = "e")
...
rash.grid(row = 0, column = 1, sticky = "w")
rash1 = tk.Checkbutton(integumentary_frame, variable = rash_var)
rash1.grid(row = 0, column = 0, sticky = "e")
